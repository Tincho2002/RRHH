...
# --- CSS Y ANIMACIÓN DE INICIO ---
st.markdown("""
<style>
    /* Ocultamos visualmente el menú y la barra superior al inicio (sin quitarlos del DOM) */
    ...
    .main-app-content {
        opacity: 0;
        animation: fadeInApp 1s ease-in 3.8s forwards;
    }
    ...
    .app-card {
        ...
        color: #333; min-height: 180px; display: flex;
...
# --- HTML DE LA ANIMACIÓN DE INICIO ---
st.markdown("""
...
# --- JAVASCRIPT PARA MOSTRAR LA APP Y REACTIVAR EL MENÚ ---
st.markdown("""
<script>
    setTimeout(() => {
        document.querySelectorAll('[data-testid="stSidebar"], [data-testid="stHeader"]')
