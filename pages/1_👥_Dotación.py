...
def load_and_clean_data(uploaded_file):
    ...
    # *** LEGAJO ADICIONADO: convertir a num y luego a string para filtros multiselect ***
    ...
    # *** LEGAJO ADICIONADO A LA NORMALIZACION DE COLUMNAS DE TEXTO PARA QUE PUEDA FILTRARSE ***
...
if uploaded_file is not None:
    ...
    # *** LEGAJO ADICIONADO AL CONFIG DE FILTROS ***
    filter_cols_config = {
        ...
        'LEGAJO': 'Legajo'  # *** agregué Legajo aquí al final para que aparezca en el sidebar ***
    }
    ...
    with tab_brutos:
        ...
        if 'LEGAJO' in display_df.columns:
            # mostrar legajo con el formato entero si corresponde
