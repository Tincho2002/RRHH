...
    if df_excel.empty: return pd.DataFrame()
    # Se omite la conversión numérica original de LEGAJO, se tratará como string
...
all             col_table_cat, col_chart_cat = st.columns([1, 2])
            with col_chart_cat:
...
        if 'LEGAJO' in display_df.columns:
            # --- INICIO DE MODIFICACIÓN 5 (Ajustar formateo en tab_brutos) ---
            # Modificado para manejar strings que pueden ser números
